...
import { upsertRecord, useAppData } from "../../../src/data/appStore";
import {
  colors,
  getCardWidth,
  getColumnCount,
    ...
    return (
      ...
      >
        <View style={styles.formCard}>
          <Text style={styles.formTitle}>Visitor access</Text>
          <Text style={styles.detailText}>
            Sign in with an MSU account to save class schedules and reminders.
          </Text>
        </View>
      </SecondaryScreenLayout>
    );
