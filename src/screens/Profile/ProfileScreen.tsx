...
import { signOut, useAuthSession } from "../../auth/localAuth";
import { databaseTables } from "../../data/mymsuDatabase";
import { colors, maxContentWidth, radii, shadow } from "../../theme";
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        {!user ? (
          <View style={styles.card}>
            ...
            <Text style={styles.cardText}>
              Sign in as student or admin to view account access.
            </Text>
            <Pressable
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            The local data model mirrors the capstone ERD and can sync with
            Firebase or migrate to SQLite using the included schema.
          </Text>
